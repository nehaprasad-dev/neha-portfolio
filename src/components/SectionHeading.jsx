const icons = {
  ...
  recognition: (
    ...
    >
      ...
      <path d="M14 14.66V17c0 .55.47.98.97 1.21 2.18 1.54 3 2.79 3 4" />
...
export default function SectionHeading({ title, icon }) {
  ...
  return (
    <div className="section-heading">
      <div className="section-heading-icon">{graphic}</div>
      <h2 className="section-title section-heading-title">{title}</h2>
    </div>
  );
}
